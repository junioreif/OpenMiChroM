...
setup(
    ...
    packages=find_packages(include=["OpenMiChroM", "OpenMiChroM.*"]),
    package_data={
        "OpenMiChroM": [
            "share/MiChroM.ff",
            "_cndb_stream/py.typed",
            "_cndb_stream/_vendor/README.md",
            "_cndb_stream/_vendor/hdf5_indexed_reader/LICENSE",
        ],
    },
